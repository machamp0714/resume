...
現職ではアプリケーション開発を中心に AWS の設計構築や、CICD の導入に寄与しました。
...
現職では開発業務だけでなく、顧客との MTG から入ることで要件定義からリリース及び運用まで
一貫した開発経験を積むことが出来ました。また Terraform を社内に導入する経験まで得られたことには
大変感謝しているのですが、今後は顧客の言われたとおりに開発を進めるのではなく、技術でプロダクトの成長に
貢献していきたい身としては、急成長しているフェーズの企業にてこれまで培った開発経験を活かして
職能で役割を縛られることがなく仕事が出来る環境を求めて転職活動に取り組んでいます。
